...
@Component({
  selector: 'app-editar-auto-nuevo',
  templateUrl: './editar-auto-nuevo.component.html',
  styleUrls: ['./editar-auto-nuevo.component.css']
})
export class EditarAutoNuevoComponent implements OnInit {
